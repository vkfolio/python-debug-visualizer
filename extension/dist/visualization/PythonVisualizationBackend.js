...
class PythonVisualizationBackend {
     ...
     */
    async getVisualizationData(expression, preferredExtractorId) {
     ...
     */
    async getVisualizationWithPointers(dataExpression, pointerExpressions, preferredExtractorId) {
        ...
        if (result.result.data.root) {
            ...
            const collectIds = (node) => {
                if (!node)
                    return;
                if (node.pythonId)
                    treeIds.push(String(node.pythonId));
                if (node.children)
     ...
     */
    buildVisualizationExpression(expression, preferredExtractorId) {
     ...
     */
    parseVisualizationResult(resultStr) {
...
exports.PythonVisualizationBackend = PythonVisualizationBackend;
//# sourceMappingURL=PythonVisualizationBackend.js.map